...
export interface PreparedCollectionData {
  ...
  wineDetails?: { [catalogNumber: string]: { price?: string; volume?: string } };
...
export class CollectionDataBuilder {
  ...
  async prepareCollectionData(
    ...
    const wineDetails = collection.metadata?.wineDetails as { [catalogNumber: string]: { price?: string; volume?: string } } || {};
